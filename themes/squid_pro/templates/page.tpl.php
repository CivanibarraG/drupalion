...
/**
 * @file
 * Squid Pro's theme implementation to display a single Drupal page.
 *
 * Available variables:
 *
    ...
    <div class="slider_wrapper grid_12">
      <div class="slides">
        <div class="slider_container">
          <div class="slide-image"><span class="img-effect"></span><img width="940" height="450" src="<?php print base_path() . drupal_get_path('theme', 'squid_pro') . '/images/slider_image_1.jpg'; ?>" />
          </div> <!-- .slide-image -->
      ...
      <div class="slides">
        <div class="slider_container">
          <div class="slide-image"><span class="img-effect"></span><img width="940" height="450" src="<?php print base_path() . drupal_get_path('theme', 'squid_pro') . '/images/slider_image_2.jpg'; ?>" />
          </div> <!-- .slide-image -->
        </div> <!-- .slider_container -->
      ...
      <div class="slides">
        <div class="slider_container">
          <div class="slide-image"><span class="img-effect"></span><img width="940" height="450" src="<?php print base_path() . drupal_get_path('theme', 'squid_pro') . '/images/slider_image_3.jpg'; ?>" />
          </div> <!-- .slide-image -->
        </div> <!-- .slider_container -->
...
<!-- preface region ends here -->
    <?php if ($page['header']): ?><div id="header_main" class="grid_12 clearfix"><?php print render($page['header']); ?></div><hr class="carved" /><?php endif; ?>
</div>
<!-- main content begins here -->
  ...
  <?php if ($page['sidebar_first']): ?>
    <aside id="sidebar-left" class="grid_3 sidebar" role="complementary">
  ...
  <?php endif; ?>
    ...
    <aside id="sidebar-right" class="grid_3 sidebar" role="complementary">
